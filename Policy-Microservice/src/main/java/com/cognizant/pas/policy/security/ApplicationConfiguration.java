package com.cognizant.pas.policy.security;

import com.cognizant.pas.policy.service.AuthenticationProviderImpl;
import com.cognizant.pas.policy.jwt.JwtTokenVerifier;
import com.cognizant.pas.policy.jwt.JwtUtility;
import com.cognizant.pas.policy.jwt.UsernamePasswordAuthenticationFilterImpl;
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.cors().and().csrf(csrf -> csrf.disable())
				...
				.authorizeRequests(request -> request
						...
						.permitAll().antMatchers("/h2-console/**").permitAll().antMatchers("/manage/**").permitAll()
